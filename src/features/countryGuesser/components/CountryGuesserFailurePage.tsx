...
function CountryGuesserFailurePage(props: CountryGuesserFailurePageProps) {
    ...
    return (
        <div id='country-guesser-failure-page' className='fade-in'>
            {!newGameStarted && <div id='country-failure' style={{ maxWidth: '700px', margin: '0 auto' }}>
                <h2 style={{ fontSize: '2.5rem', marginBottom: 'var(--spacing-lg)' }}>Game Over</h2>
                <p style={{ color: '#f87171', fontSize: '1.3rem', marginBottom: 'var(--spacing-lg)' }}>You failed. Better luck next time!</p>
                <p style={{ fontSize: '1.1rem', marginBottom: 'var(--spacing-lg)' }}>The answer was <a href={map} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary-light)', textDecoration: 'underline' }}>{name}</a></p>
